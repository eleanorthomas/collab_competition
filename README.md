...
The solution is contained in Tennis.ipynb. Follow the steps in the Jupyter notebook to Start the Environment, Examine the State and Action Spaces, initialize the MADDPG code, solve the task, and run the final cell to view a plot of the scores per episode.
...
- checkpoint_critic_1.pt - Trained Critic weights for Agent 1
